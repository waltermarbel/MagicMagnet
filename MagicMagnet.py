...
mainLayout = [
    [sg.Text('\n', font=(font, 5))],
    [sg.Text('  Magic Magnet', font=(font, 24), text_color='#ff0000', justification='left'), sg.Image('icon.png')],
    [sg.Text('    Search for something', font=(font, 14))],
    [sg.Text('\n', font=(font, 1))],
    [sg.Text('  '), sg.InputText(size=(28, 6), font=(font, 12)), sg.VerticalSeparator(pad=(4, (3, 4))), sg.Submit('Search', size=(12, 0), font=(font, 10, 'bold'))],
    [sg.Text('\n', font=(font, 1))],
    ...
    [sg.Text('  '), sg.Checkbox('Google', key='Google', font=(font, 12), size=(11, 1), default=engines['Google'], enable_events=True),
     sg.Checkbox('The Pirate Bay', key='The Pirate Bay', font=(font, 12), size=(16, 1), default=engines['The Pirate Bay'], enable_events=True),
    ...
    [sg.Text('  '), sg.Checkbox('Nyaa', key='Nyaa', font=(font, 12), size=(11, 1), default=engines['Nyaa'], enable_events=True),
     sg.Checkbox('Demonoid', key='Demonoid', font=(font, 12), size=(16, 1), default=engines['Demonoid'], enable_events=True),
     sg.Checkbox('YTS', key='YTS', font=(font, 12), default=engines['YTS'], enable_events=True)],
    [sg.Text('  '), sg.Checkbox('ETTV', key='ETTV', font=(font, 12), size=(11, 1), default=engines['ETTV'], enable_events=True),
     sg.Checkbox('EZTV', key='EZTV', font=(font, 12), size=(16, 1), default=engines['EZTV'], enable_events=True)],
    [sg.Text('\n', font=(font, 1))],
    [sg.Text(f'    Application theme', font=(font, 14)), sg.Radio('Light', 'theme', key='LightSkin', default=meta.get('themeLight'), font=(font, 12)), sg.Radio('Dark', 'theme', key='DarkSkin', default=meta.get('themeDark'), font=(font, 12)), sg.Button('Apply', size=(7, 0), font=(font, 10, 'bold'))],
    [sg.Text('\n', font=(font, 1))],
    [sg.Text('  '), sg.Button('Support this project', size=(17, 0), font=(font, 10, 'bold')), sg.VerticalSeparator(pad=(6, 3)), sg.Button('About', size=(7, 0), font=(font, 10, 'bold')), sg.VerticalSeparator(pad=(6, 3)), sg.Button('Exit', size=(12, 0), font=(font, 10, 'bold'))],
    [sg.Text('\nDeveloped by Pedro Lemos (@pedrolemoz)', font=(font, 12), size=(42, 0), justification='center')]
]
...
while True:
    ...
    if event == 'Apply':
        ...
        if status:
            restartLayout = [
                [sg.Text('\n', font=(font, 5))],
                [sg.Text('Restart to apply changes', font=(font, 14), size=(20, 0), justification='left')],
                [sg.Text('\n', font=(font, 1))]
            ]
    ...
    if event == 'Search':
        ...
        while True:
            ...
            if resultsEvent == 'Copy magnet link':
                ...
                clipboardLayout = [
                    [sg.Text('\n', font=(font, 5))],
                    [sg.Text('Copied to clipboard!', font=(font, 14), size=(17, 0), justification='left')],
                    [sg.Text('\n', font=(font, 1))]
                ]
